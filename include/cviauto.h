...
#define E_CVIAUTO_USER_ERROR_BASE ((HRESULT)-2147220224)
...
VARIANT CVIFUNC CA_VariantLongLong(__int64 val);
...
VARIANT CVIFUNC CA_VariantULongLong(unsigned __int64 val);
...
HRESULT CVIFUNC CA_VariantHasLongLong(const VARIANT *v);
HRESULT CVIFUNC CA_VariantHasULongLong(const VARIANT *v);
...
HRESULT CVIFUNC CA_VariantSetLongLong(VARIANT *v, __int64 val);
...
HRESULT CVIFUNC CA_VariantSet1DArray(VARIANT *v, unsigned int cavt, size_t numElements, const void *array);
HRESULT CVIFUNC CA_VariantSet2DArray(VARIANT *v, unsigned int cavt, size_t dim1Size, size_t dim2Size, const void *array);
...
HRESULT CVIFUNC CA_VariantSetULongLong(VARIANT *v, unsigned __int64 val);
...
HRESULT CVIFUNC CA_VariantSetLongLongPtr(VARIANT *v, __int64 *val);
...
HRESULT CVIFUNC CA_VariantSetULongLongPtr(VARIANT *v, unsigned __int64 *val);
...
HRESULT CVIFUNC CA_VariantGetLongLong(const VARIANT *v, __int64 *longlongPtr);
...
HRESULT CVIFUNC CA_VariantGet1DArray(VARIANT *v, unsigned int cavt, void *array, size_t *dimSz);
HRESULT CVIFUNC CA_VariantGet2DArray(VARIANT *v, unsigned int cavt, void *array, size_t *dim1Sz, size_t *dim2Sz);
HRESULT CVIFUNC CA_VariantGet1DArrayBuf(VARIANT *v, unsigned int cavt, void *buf,
                                    size_t bufSizeInBytes, size_t *numElements);
HRESULT CVIFUNC CA_VariantGet2DArrayBuf(VARIANT *v, unsigned int cavt, void *buf,
                                    size_t bufSizeInBytes, size_t *dim1NumElements,
                                    size_t *dim2NumElements);
HRESULT CVIFUNC CA_VariantGetArrayNumDims(const VARIANT *v, unsigned int *numDimensions);

HRESULT CVIFUNC CA_VariantGet1DArraySize(const VARIANT *v, size_t *numElements);
HRESULT CVIFUNC CA_VariantGet2DArraySize(const VARIANT *v, size_t *dim1NumElements, size_t *dim2NumElements);
...
HRESULT CVIFUNC CA_VariantGetULongLong(const VARIANT *v, unsigned __int64 *uLongLongPtr);
...
HRESULT CVIFUNC CA_VariantGetCStringBuf(VARIANT *v, char *stringBuf, size_t bufSize);
...
HRESULT CVIFUNC CA_VariantGetLongLongPtr(const VARIANT *v, __int64 **ppLongLong);
...
HRESULT CVIFUNC CA_VariantGetULongLongPtr(const VARIANT *v, unsigned __int64 **ppULongLong);
...
void *CVIFUNC   CA_AllocMemory(size_t numBytes);
...
HRESULT CVIFUNC CA_SafeArrayTo2DArrayEx(LPSAFEARRAY *ppSafeArray, unsigned int cavt, unsigned int options,
                                        void *array, size_t *dim1Sz, size_t *dim2Sz);
HRESULT CVIFUNC CA_SafeArrayTo1DArrayBufEx(LPSAFEARRAY *ppSafeArray, unsigned int cavt, unsigned int options,
                                           void *buf, size_t bufSizeInBytes, size_t *numElements);
HRESULT CVIFUNC CA_SafeArrayTo2DArrayBufEx(LPSAFEARRAY *ppSafeArray, unsigned int cavt, unsigned int options,
                                           void *buf, size_t bufSizeInBytes, size_t *dim1NumElements,
                                           size_t *dim2NumElements);
HRESULT CVIFUNC CA_SafeArrayGetNumDims(LPSAFEARRAY pSafeArray, unsigned int *numDimensions);

HRESULT CVIFUNC CA_SafeArrayGet1DSize(LPSAFEARRAY pSafeArray, size_t *numElements);
HRESULT CVIFUNC CA_SafeArrayGet2DSize(LPSAFEARRAY pSafeArray, size_t *dim1NumElements, size_t *dim2NumElements);
...
void CVIFUNC    CA_GetAutomationErrorString(HRESULT error, char buf[], size_t bufSize);
...
HRESULT CVIFUNC CA_BSTRGetCStringBuf(BSTR bstr, char *stringBuf, size_t bufSize);
...
HRESULT CVIFUNC CA_GetActiveObjectByClassIdEx(const GUID *classId, const char *server, const IID *iid,
                                              int supportMultithreading, LCID locale, intptr_t reserved,
                                              CAObjHandle *objHandle);
...
HRESULT CVIFUNC CA_LoadObjectFromFileByClassIdEx(const char *fileName, const GUID *classId, const char *server,
                                                 ...
                                                 intptr_t reserved, CAObjHandle *objHandle);
...
HRESULT CVIFUNC CA_CreateObjHandleFromInterface(void *input, const IID *iid, int supportMultithreading,
                                                LCID locale, intptr_t reserved, int addRef,
                                                CAObjHandle *objHandle);
...
HRESULT CVIFUNC_C CA_MethodInvoke(CAObjHandle objHandle, ERRORINFO *exceptInfo,
                         ...
                         size_t paramCount, unsigned int paramTypes[], ... /* actual args */);
HRESULT CVIFUNC CA_MethodInvokeV(CAObjHandle objHandle, ERRORINFO *exceptInfo,
                          int methodId, unsigned int returnType, void *retval,
                          size_t paramCount, unsigned int paramTypes[], va_list args);
...
typedef intptr_t CAServerObjHandle;
...
HRESULT CVIFUNC CA_InitActiveXServer (HINSTANCE serverHInstance, ServerModuleType moduleType,
                                      ...
                                      int *runServer, char *errStrBuf, size_t bufSize);
