...
/*                                                                            */
/* Title:       gpib.h                                                        */
/* Purpose:     Include file for Win32, Win64, and Solaris 2                  */
/*                                                                            */
/*============================================================================*/
...
/**************************************************************************/
int CVIGPIBFUNC OpenDev (const char *devname, const char *instrPrefix);
int CVIGPIBFUNC CloseDev (int bd);
int CVIGPIBFUNC CloseInstrDevs (const char *instrPrefix);
...
#ifndef _NI_mswin64_
int CVIGPIBFUNC ibbna (int ud, const char *udname);
#endif
int CVIGPIBFUNC ibcac (int ud, int v);
int CVIGPIBFUNC ibclr (int ud);
int CVIGPIBFUNC ibcmd (int ud, const void *buf, size_t cnt);
int CVIGPIBFUNC ibcmda (int ud, const void *buf, size_t cnt);
...
#if defined(_NI_mswin32_) && !defined(_NI_mswin64)
int CVIGPIBFUNC ibevent (int ud, short *event);  /* MS Windows only */
#endif
int CVIGPIBFUNC ibfind (const char *udname);
...
#ifdef _NI_mswin64_
#ifndef ibonl
#define ibonl __CVI_ibonl
int CVIGPIBFUNC __CVI_ibonl (int ud, int v);
#endif
#endif
...
int CVIGPIBFUNC ibrdf (int ud, const char *filename);
#ifndef _NI_mswin64_
...
int CVIGPIBFUNC ibwrt (int ud, const void *buf, size_t cnt);
int CVIGPIBFUNC ibwrta (int ud, const void *buf, size_t cnt);
int CVIGPIBFUNC ibwrtf (int ud, const char *filename);
#ifndef _NI_mswin64_
...
void CVIGPIBFUNC AllSpoll (int boardID, const Addr4882_t taddrs[], short results[]);
void CVIGPIBFUNC DevClear (int boardID, Addr4882_t address);
void CVIGPIBFUNC DevClearList (int boardID, const Addr4882_t addrlist[]);
void CVIGPIBFUNC EnableLocal (int boardID, const Addr4882_t laddrs[]);
void CVIGPIBFUNC EnableRemote (int boardID, const Addr4882_t laddrs[]);
void CVIGPIBFUNC FindLstn (int boardID, const Addr4882_t pads[], Addr4882_t results[], size_t limit);
void CVIGPIBFUNC FindRQS (int boardID, const Addr4882_t taddrs[], short *dev_stat);
...
void CVIGPIBFUNC PPollUnconfig (int boardID, const Addr4882_t laddrs[]);
...
void CVIGPIBFUNC ResetSys (int boardID, const Addr4882_t laddrs[]);
void CVIGPIBFUNC Send (int boardID, Addr4882_t listener, const void *buf, size_t datacnt, int eotMode);
void CVIGPIBFUNC SendCmds (int boardID, const void *buf, size_t cnt);
void CVIGPIBFUNC SendDataBytes (int boardID, const void *buf, size_t cnt, int eot_mode);
void CVIGPIBFUNC SendIFC (int boardID);
void CVIGPIBFUNC SendLLO (int boardID);
void CVIGPIBFUNC SendList (int boardID, const Addr4882_t laddrs[], const void *buf, size_t datacnt, int eotMode);
void CVIGPIBFUNC SendSetup (int boardID, const Addr4882_t laddrs[]);
void CVIGPIBFUNC SetRWLS (int boardID, const Addr4882_t laddrs[]);
void CVIGPIBFUNC TestSRQ (int boardID, short *result);
void CVIGPIBFUNC TestSys (int boardID, const Addr4882_t addrs[], short result[]);
void CVIGPIBFUNC Trigger (int boardID, Addr4882_t laddrs);
void CVIGPIBFUNC TriggerList (int boardID, const Addr4882_t laddrs[]);
...
#define EARM 22  /* ibnotify failed to rearm.              */
#define EHDL 23  /* Invalid handle was passed.             */
#define EWIP 26  /* ibwait is already in process.          */
#define ERST 27  /* Event notification cancelled due to a  */
                 /* reset of the interface.                */
#define EPWR 28  /* Interface lost power.                  */
