...
#define ATTR_SYSTEM_MONITOR_HANDLE                  1801        /* HMONITOR (not settable) */
...
#define VAL_KEEP_SAME_POSITION  -2147483647L /* for DuplicateCtrl */
                                            /* and DuplicatePanel */
...
#define EVENT_TIMER_TICK                    15  /* eventData1 = ptr to current time (*double) in 32-bit executable */
                                                /* eventData2 = ptr to time since the control last
                                                        received EVENT_TIMER_TICK (*double) in 32-bit executable */
                                                /* Use GetTimerTickData to retrieve current time value and elapsed time 
                                                        values in a 64-bit executable */
...
typedef enum
{
    ...
    UIEInvalidStatusBarId                                       = -174,
    UIECtrlNotOnStatusBar                                       = -175,
    UIEErrorLimit                                               = -176
} UIError;
